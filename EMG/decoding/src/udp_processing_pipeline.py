...
class BCIProcessingPipeline:
    ...
    def process_data(self):
        ...
        # return sqrt(self.buffer_sum_one / self.buffer_size), sqrt(self.buffer_sum_two / self.buffer_size)
    ...
    def predict(self, new_data_one, new_data_two):
        ...
        # predict_prob_one = self.loaded_model_one.predict_proba(asarray(rms_one).reshape(-1,1))[0]
        # predict_prob_two = self.loaded_model_two.predict_proba(asarray(rms_one).reshape(-1,1))[0]
